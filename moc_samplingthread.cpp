...
**
** Created: Mon Mar 26 23:44:34 2012
...
static const char qt_meta_stringdata_SamplingThread[] = {
    "SamplingThread\0\0double\0appendNewPoint(double)\0"
};
...
int SamplingThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: { double _r = appendNewPoint((*reinterpret_cast< double(*)>(_a[1])));
...
// SIGNAL 0
double SamplingThread::appendNewPoint(double _t1)
{
    double _t0;
